    ...
    <main className="mx-auto flex h-screen max-w-6xl gap-4 p-4">
      <aside className="w-64 shrink-0 overflow-y-auto rounded-lg border border-neutral-200 p-2 dark:border-neutral-800">
        <div className="mb-2 flex items-center justify-between">
          ...
          <div className="flex gap-2 text-xs">
            ...
            <Link href={`/db/${id}/schema/advisor`} className="text-blue-600">Workload advisor</Link>
            <Link href={`/db/${id}/schema/datamart-advisor`} className="text-blue-600">Datamart advisor</Link>
      ...
      <section className="flex-1 overflow-y-auto rounded-lg border border-neutral-200 p-4 dark:border-neutral-800">
        <div className="mb-3 flex items-center justify-between">
          {selected && <Link href={`/db/${id}/chat`} className="text-sm text-blue-600">Chat →</Link>}
        </div>
        {!table ? (
          ...
          <>
            ...
            <div className="mb-2 flex items-center gap-2">
              ...
              <Link href={`/db/${id}/context`} className="text-sm text-blue-600">Annotate in Context Studio</Link>
            </div>
