          ...
          return (
            <div key={a.toolCallId} className={selected === a.toolCallId ? '' : 'hidden'}>
              <QueryResultBlock
                ...
                initialResult={ok ? { columns: a.columns!, rows: a.rows ?? [], executedSql: a.executedSql, lineage: a.lineage, accelerated: a.accelerated, verifyChecks: a.verifyChecks } : undefined}
